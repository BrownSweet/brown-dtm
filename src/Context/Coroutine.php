...
use ArrayObject;
use Dtm\Context\CoroutineInterface;
use Dtm\Context\CoroutineDestroyedException;
use Dtm\Context\RunningInNonCoroutineException;
use Dtm\Context\RuntimeException;
...
class Coroutine implements CoroutineInterface
{
    ...
    public static function pid(?int $id = null): int
    {
        ...
        if ($cid === false) {
            throw new \Dtm\Context\RunningInNonCoroutineException('Non-Coroutine environment don\'t has parent coroutine id.');
        }
        return max(0, $cid);
    }
